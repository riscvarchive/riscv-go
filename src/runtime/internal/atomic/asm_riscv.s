...
TEXT ·Casuintptr(SB),NOSPLIT,$0-32
	JMP ·Casp1(SB)

TEXT ·StoreUintptr(SB),NOSPLIT,$0-16
	MOV	addr+0(FP), A0
	MOV	val+8(FP), A1
	// Since addr is aligned, this store is atomic automatically.
	MOV	A1, (A0)
	RET

TEXT ·Loaduintptr(SB),NOSPLIT,$0-16
	MOV	addr+0(FP), A0
	// Since addr is aligned, this load is atomic automatically.
	MOV	(A0), A0
	MOV	A0, val+8(FP)
	RET
