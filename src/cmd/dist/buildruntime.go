...
func mkzversion(dir, file string) {
	// FIXME: We need large stacks until we can link in the runtime,
	// to avoid needing to ever call runtime.morestack.
	// The + 20 * GoarchRiscv should be removed.
	out := fmt.Sprintf(
