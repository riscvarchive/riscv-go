...
func rewriteValueRISCV_OpRsh16x16(v *Value, config *Config) bool {
	...
	// cond:
	// result: (SRA <t> x (OR <y.Type> y (Neg16 <y.Type> (Geq16 <y.Type> y (MOVWconst [64])))))
	for {
		t := v.Type
		x := v.Args[0]
		y := v.Args[1]
		...
		v0.AddArg(y)
		v1 := b.NewValue0(v.Line, OpNeg16, y.Type)
		v2 := b.NewValue0(v.Line, OpGeq16, y.Type)
		v2.AddArg(y)
		v3 := b.NewValue0(v.Line, OpRISCVMOVWconst, config.fe.TypeUInt16())
		v3.AuxInt = 64
		v2.AddArg(v3)
		v1.AddArg(v2)
		v0.AddArg(v1)
...
func rewriteValueRISCV_OpRsh16x32(v *Value, config *Config) bool {
	...
	// cond:
	// result: (SRA <t> x (OR <y.Type> y (Neg32 <y.Type> (Geq32 <y.Type> y (MOVLconst [64])))))
	for {
		t := v.Type
		x := v.Args[0]
		y := v.Args[1]
		...
		v0 := b.NewValue0(v.Line, OpRISCVOR, y.Type)
		v0.AddArg(y)
		v1 := b.NewValue0(v.Line, OpNeg32, y.Type)
		v2 := b.NewValue0(v.Line, OpGeq32, y.Type)
		v2.AddArg(y)
		v3 := b.NewValue0(v.Line, OpRISCVMOVLconst, config.fe.TypeUInt32())
		v3.AuxInt = 64
		v2.AddArg(v3)
		v1.AddArg(v2)
		v0.AddArg(v1)
...
func rewriteValueRISCV_OpRsh16x64(v *Value, config *Config) bool {
	...
	// cond:
	// result: (SRA <t> x (OR <y.Type> y (Neg64 <y.Type> (Geq64 <y.Type> y (MOVQconst [64])))))
	for {
		t := v.Type
		x := v.Args[0]
		y := v.Args[1]
		...
		v0 := b.NewValue0(v.Line, OpRISCVOR, y.Type)
		v0.AddArg(y)
		v1 := b.NewValue0(v.Line, OpNeg64, y.Type)
		v2 := b.NewValue0(v.Line, OpGeq64, y.Type)
		v2.AddArg(y)
		v3 := b.NewValue0(v.Line, OpRISCVMOVQconst, config.fe.TypeUInt64())
		v3.AuxInt = 64
		v2.AddArg(v3)
		v1.AddArg(v2)
		v0.AddArg(v1)
...
func rewriteValueRISCV_OpRsh16x8(v *Value, config *Config) bool {
	...
	// match: (Rsh16x8  <t> x y)
	// cond:
	// result: (SRA <t> x (OR <y.Type> y (Neg8  <y.Type> (Geq8  <y.Type> y (MOVBconst [64])))))
	for {
		t := v.Type
		x := v.Args[0]
		y := v.Args[1]
		...
		v0 := b.NewValue0(v.Line, OpRISCVOR, y.Type)
		v0.AddArg(y)
		v1 := b.NewValue0(v.Line, OpNeg8, y.Type)
		v2 := b.NewValue0(v.Line, OpGeq8, y.Type)
		v2.AddArg(y)
		v3 := b.NewValue0(v.Line, OpRISCVMOVBconst, config.fe.TypeUInt8())
		v3.AuxInt = 64
		v2.AddArg(v3)
		v1.AddArg(v2)
		v0.AddArg(v1)
