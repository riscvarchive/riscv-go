...
func rewriteValueRISCV_OpHmul16(v *Value, config *Config) bool {
	...
	// match: (Hmul16 x y)
	// cond:
	// result: (SRAI [16] (MULW <i32> (SignExt16to32 x) (SignExt16to32 y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRISCVSRAI)
		v.AuxInt = 16
		v0 := b.NewValue0(v.Line, OpRISCVMULW, i32)
		v1 := b.NewValue0(v.Line, OpSignExt16to32, config.fe.TypeInt32())
		v1.AddArg(x)
		v0.AddArg(v1)
...
func rewriteValueRISCV_OpHmul16u(v *Value, config *Config) bool {
	...
	// match: (Hmul16u x y)
	// cond:
	// result: (SRLI [16] (MULW <u32> (ZeroExt16to32 x) (ZeroExt16to32 y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRISCVSRLI)
		v.AuxInt = 16
		v0 := b.NewValue0(v.Line, OpRISCVMULW, u32)
		v1 := b.NewValue0(v.Line, OpZeroExt16to32, config.fe.TypeUInt32())
		v1.AddArg(x)
		v0.AddArg(v1)
...
func rewriteValueRISCV_OpHmul32(v *Value, config *Config) bool {
	...
	// match: (Hmul32 x y)
	// cond:
	// result: (SRAI [32] (MUL  <i64> (SignExt32to64 x) (SignExt32to64 y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRISCVSRAI)
		v.AuxInt = 32
		v0 := b.NewValue0(v.Line, OpRISCVMUL, i64)
...
func rewriteValueRISCV_OpHmul32u(v *Value, config *Config) bool {
	...
	// match: (Hmul32u x y)
	// cond:
	// result: (SRLI [32] (MUL  <u64> (ZeroExt32to64 x) (ZeroExt32to64 y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRISCVSRLI)
		v.AuxInt = 32
		v0 := b.NewValue0(v.Line, OpRISCVMUL, u64)
...
func rewriteValueRISCV_OpHmul8(v *Value, config *Config) bool {
	...
	// match: (Hmul8 x y)
	// cond:
	// result: (SRAI [8]  (MULW <i32> (SignExt8to32 x)  (SignExt8to32 y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRISCVSRAI)
...
func rewriteValueRISCV_OpHmul8u(v *Value, config *Config) bool {
	...
	// match: (Hmul8u x y)
	// cond:
	// result: (SRLI [8]  (MULW <u32> (ZeroExt8to32 x)  (ZeroExt8to32 y)))
	for {
		x := v.Args[0]
		y := v.Args[1]
		v.reset(OpRISCVSRLI)
