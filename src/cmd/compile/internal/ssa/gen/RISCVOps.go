...
func init() {
	...
	var (
		gpstore = regInfo{inputs: []regMask{gpspsbMask, gpspMask, 0}}
	...
	RISCVops := []opData{
		// TODO: use three-operand form of ADD rather than always writing back to a source register?
		{name: "ADD", argLength: 2, reg: gp11, asm: "ADD", commutative: true, resultInArg0: true}, // arg0 + arg1
